...
public class Java8DateTimeExamples {
	...
	private static void dateTimes() {
		...
		System.out.println("date/time creation: tenthFeb2017: " + tenthFeb2017);
		System.out.println("date/time creation: firstAug2017: " + firstAug2017);
	...
	private static void year() {
		...
		boolean isLeap = currentYear.isLeap(); // false //leap year
